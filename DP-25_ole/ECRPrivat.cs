            ...
            if (Send(sendBytes))
            {
               ...
               // s += i.ToString();
                ...
                if ("КР00006552" == lStr[10]    // винил
                    ...
                    || "КР00009338" == lStr[10] // Беркут Днепр
                    || "КР00009508" == lStr[10] // Беркут Кривойрог
                    || "КР00009510" == lStr[10] // Беркут Никополь
                    || "КФ00003017" == lStr[10] // Павлоград КонтинентСервис
                    //|| "КФ00000103" == lStr[10] // test
                    //|| "КР00011818" == lStr[10] // test
                    || "КР00011621" == lStr[10] // Лысенко Пиво
                    || true
                    )
                    return dt;
